...
Public Class EASYPAISA_FRM
    Private Sub EASYPAISA_FRM_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim LOGIN_USER
    ...
    Private Sub EASYPAISA_FRM_MaximumSizeChanged(sender As Object, e As EventArgs) Handles Me.MaximumSizeChanged
        Call RESIZE_ME_PANEL()
    End Sub

    Private Sub EASYPAISA_FRM_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        Call RESIZE_ME_PANEL()
    End Sub
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("EASY PAISA", H5_fnt, Brushes.Black, 80, 120)
    ...
    Private Sub EASYPAISA_FRM_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
    ...
    Private Sub COPY_OPT_CheckedChanged(sender As Object, e As EventArgs) Handles COPY_OPT.CheckedChanged
        ...
        End If
        If COPY_OPT.Checked = False Then
